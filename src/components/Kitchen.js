  ...
  const cardInfo = [
    {
      ...
      title: 'Quizizz',
      text:
        'O Quizizz é usado por mais de 20 milhões de pessoas por mês para treinamento, orientação e integração de funcionários, envolvimento do cliente, e-Learning e ensino, em escolas, residências e escritórios em todo o mundo.',
